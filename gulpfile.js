...
gulp.task('uglify', ['build'], function() {
    return gulp.src([
        './dist/mixitup-react.js'
    ])
        .pipe(uglify({
            preserveComments: 'license'
        }))
        .pipe(rename('mixitup-react.min.js'))
        .on('error', function(e) {
...
gulp.task('build', ['build-dist'], function(done) {
    exec('node node_modules/mixitup-build/docs.js -s mixitup-react.js', function(e, out) {
        if (out) {
            console.log(out);
        }
...
gulp.task('build-dist', ['lint', 'code-style'], function(done) {
    exec('node node_modules/mixitup-build/dist.js -o mixitup-react.js', function(e, out) {
        if (out) {
            console.log(out);
        }
